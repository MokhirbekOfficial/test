...
export default class Database {
    url = `mongodb+srv://nodedev:dWBOlfL0atDT5cVx@cluster0.bkkfh.mongodb.net/TMK?retryWrites=true&w=majority`

    // url = `mongodb://127.0.0.1:${config.MongoPort}/${config.MongoDatabase}`
